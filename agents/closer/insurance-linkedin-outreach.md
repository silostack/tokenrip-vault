...
1. Read the connection's LinkedIn profile.
2. Sort them into a bucket: **A**, **B**, or **Fallback**.
3. Send the matching template, swapping in name and firm.
4. If they reply, stop using templates — coach the call ask in a live Closer session.

Bucketing takes five seconds. The system is a three-way switch, not one generic line. A wrong-but-specific guess reads worse than no guess — when in doubt, use Fallback.

---

## The buckets

### Bucket A — Volume brokerage
**Signals**: large book of business, CSR / account-manager team, ops-driven language, "service," "processing," "retention." The grind is **volume**.

**Grind line**: *what eats the most CSR time, renewals, COI processing, something else?*

### Bucket B — Technical specialist / principal
**Signals**: underwriting, coverage architecture, policy wording, carrier negotiation, advisory, "risk manager," deep-dive policy reviews. The grind is **depth**, not volume — the repetitive scaffolding around high-judgment work.

**Grind line**: *what eats the most time you'd never get back, policy reviews, carrier negotiation, something else?*

### Fallback — Can't tell
**Signals**: thin profile, generalist, mixed roles, anything ambiguous. Drop the guessed grind entirely. Go fully open.

**Grind line**: *what's the one workflow you'd hand off tomorrow if you could?*
...
```
Thanks for connecting, [Name]. I build AI agents for insurance brokerages.
Not pitching you here. We're in discovery, looking for design partners, so
I'd rather hear where the hours actually go than sell anything. For [firm /
work descriptor], [GRIND LINE]? Happy to trade notes on what we're seeing
across other brokerages.
```
...
- **No "curious...".** Every LinkedIn outreach message opens with "curious" or "I'd love to." Don't be the 50th. Lead with the discovery posture instead.
...
*v0.1 — 2026-05-19. Created in Closer session. Iterate from reply-rate data — winning-pattern file is still empty, so this rubric is a hypothesis.*
