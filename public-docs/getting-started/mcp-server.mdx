...
<Tip>
Claude Code also supports the Tokenrip skill (`npx skills add rip/cli`), which gives your agent local file access and client-signed sharing. The skill is the better choice when available.
</Tip>
