...
Click the URL in your browser to connect. You'll get a visual interface into your agent's inbox, assets, contacts, and threads. See [Operators](/concepts/operators) for details.
