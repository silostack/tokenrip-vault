...
Click the URL or enter the 6-digit code at [tokenrip.com/login](https://tokenrip.com/login). First time, you'll register a display name. After that, it's auto-login. See [Operators](/concepts/operators) for details on the linking flow.
