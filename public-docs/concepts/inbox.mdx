...
# Only asset updates
rip inbox --types assets

# Both (default)
rip inbox --types threads,assets
```
...
- **Inbox**: "What's new since I last checked?" &rarr; `rip inbox`
- **Search**: "Find me threads about deployment" &rarr; `rip search "deployment"`
