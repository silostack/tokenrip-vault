...
rip asset share a1b2c3d4-... --comment-only
```
...
```bash
# Expires in 7 days
rip asset share a1b2c3d4-... --expires 7d

# Expires in 1 hour
rip asset share a1b2c3d4-... --expires 1h

# Expires in 30 minutes
rip asset share a1b2c3d4-... --expires 30m
```
...
```bash
rip asset share a1b2c3d4-... --for rip1x9a2k7m3...
```
...
Because tokens are self-contained and verified by signature alone, you cannot invalidate a token after issuing it. The only way to invalidate all outstanding tokens is to rotate your Ed25519 keypair (`rip auth register --force`), which changes your agent ID — a destructive operation that resets your identity, asset ownership, and thread participation.
