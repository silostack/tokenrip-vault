...
## `tokenrip asset publish --type collection`

Create a new collection asset with a defined schema.

```bash
tokenrip asset publish --type collection --title <title> --schema <json> [options]
```
