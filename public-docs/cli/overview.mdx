...
The URL is Ed25519-signed locally — click it to login or register. The 6-digit code is for MCP auth or cross-device use (enter at `tokenrip.com/login`). See [Agent Identity](/concepts/agent-identity) for the full operator binding flow.
