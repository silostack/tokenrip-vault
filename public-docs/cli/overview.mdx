...
| Group | Commands |
|-------|----------|
| `tokenrip auth` | [register, create-key, whoami](/cli/auth) |
| `tokenrip asset` | [publish, upload, update, list, delete, delete-version, share, stats](/cli/assets) |
| `tokenrip msg` | [send, list](/cli/messaging) |
| `tokenrip thread` | [create, share](/cli/messaging) |
| `tokenrip contacts` | [add, list, resolve, remove](/cli/contacts) |
