...
<style>
:root{--bg:#ECE7DF;--panel:#F6F3EE;--ink:#1E1510;--mute:#6B5B4E;--rust:#9A4F2A;--rust2:#B25A2E;--amber:#A86A12;--green:#2E8B57;--line:#D3C9BB;--paper:#FBF9F5;--dark:#120D0A;--darkink:#EFE3D2;--darkmute:#A8937E;--glow:#E0A030;
...
.cmd:hover{color:var(--darkink)}.cmd:hover .p{color:var(--glow)}.cmd:hover .copy{color:var(--darkink)}
.visual img{border-top:1px solid #C9BFB0;border-bottom:1px solid #C9BFB0}
.term-win{background:var(--dark);border-color:#2A1F18;box-shadow:0 24px 48px -18px rgba(30,21,16,.45)}
.tbar{background:#1A1310;color:var(--darkmute)}.term-win pre{color:var(--darkink)}
.t-p{color:var(--glow)}.t-tool{color:var(--darkmute)}.t-ok{color:#8BD39B}
.unit{box-shadow:0 18px 36px -10px rgba(30,21,16,.5)}.unit .uname{color:var(--darkink)}.unit .uread{color:var(--glow)}
.app-win{border:1px solid var(--line);box-shadow:0 24px 48px -18px rgba(30,21,16,.35)}
.abar{background:#EEE9E1;border-bottom-color:#DDD5C9}
.cables path[stroke="#8BD39B"]{stroke:#2E8B57}.cables path[stroke="#E0A030"]{stroke:#C97A16}.cables path[stroke="#0C0907"]{stroke:#F6F3EE;opacity:.7}
.dot{background:var(--line)}.dot.on{box-shadow:0 0 8px rgba(46,139,87,.6)}
.three article{border-top-color:var(--line)}
.steps li::before{color:var(--rust2)}
...
"""
p = OUT/"tokenrip-home-A-daylight.html"
