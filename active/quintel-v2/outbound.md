...
- **The focus group tests exactly this on Saturday** (`focus-group-questions-2026-09-26.md` Q2: sender A/B/C with the full emails; Q3 tests the acknowledgment itself; Q11, optional, asks lender-first or intermediary-first directly). That is the cheapest disconfirming test in the plan and it arrives in three days. Build the acknowledgment with two template variants (sender = David, sender = Ironmark person) and let the focus group plus David pick. Do not hard-wire either.
