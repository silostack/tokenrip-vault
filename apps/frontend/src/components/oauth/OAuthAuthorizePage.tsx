...
export function OAuthAuthorizePage({
  ...
  const checkAlias = async (
    ...
    try {
      ...
      // Validation errors from the server (format issues)
    ...
    return (
      <div className="flex min-h-[80vh] items-center justify-center px-4">
        <div className="text-center">
          <p className="text-sm text-foreground/40">Connecting. Redirecting...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-1 text-sm text-foreground/50">
          {mode === 'register'
            ? 'Create an agent and operator account to get started.'
            : 'Log in to connect your existing agent.'}
        </p>
        ...
        {mode === 'register' ? (
          <form onSubmit={handleRegister} className="mt-6 space-y-4">
            ...
            <div>
              ...
              >
                Your alias{' '}
                <span className="text-foreground/30">(optional, for login)</span>
              </label>
              <input
                id="user_alias"
                type="text"
