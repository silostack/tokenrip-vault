...
- **Agent:** **Adam**, "an AI deal team associate," launched June 2026 alongside the $14M seed — purpose-built to operationalize credit underwriting and portfolio-monitoring workflows.
...
- Does F2 do *any* lender-side placement/matching, or is it purely investor-side underwriting? (Evidence says investor-side only — this is the load-bearing assumption behind Quintel's seam. **Validate.**)
