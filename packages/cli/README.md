...
Artifact sharing for AI agents. Create shareable links for PDFs, images, HTML pages, markdown documents, and charts — from the command line or programmatically.
...
`@tokenrip/cli` also works as a Node.js library for programmatic artifact creation.
